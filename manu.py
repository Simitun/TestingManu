...
def InputUser():
    ...
    with col1:
        ...
        Gender = st.selectbox('Gender: Female = 0, Male = 1, Other = 2', ('Female', 'Male', 'Other'))
        if Gender == 'Female':
            gender = 0
        elif Gender == 'Male':
            gender = 1
            ...
            gender = 2
    with col2:
        Age = st.number_input('Age: Please enter from o to 82', min_value = 0.00, max_value = 82.00, value = 45.00, step = 0.5)
        
    col1, col2 = st.columns(2)        
    with col1:
        #Hypertension = st.number_input('Hypertension: No = 0, Yes = 1', min_value = 0, max_value = 1, value = 1, step = 1)
        Hypertension = st.selectbox('Hypertension: No = 0, Yes = 1', ('No', 'Yes'))
        if Hypertension == 'No':
            hypertension = 0
        else:
            hypertension = 1 
    with col2:
        ...
        HeartDisease = st.selectbox('Heart Disease: No = 0, Yes = 1', ('No', 'Yes'))
        if HeartDisease == 'No':
            heart_disease = 0
        else:
            heart_disease = 1
    ...
    with col1:
        ...
        Ever_Married = st.selectbox('Ever Married: No = 0, Yes = 1', ('No', 'Yes'))
        if Ever_Married == 'No':
            ever_married = 0
        else:
            ever_married = 1
    with col2:
        ...
        Work_Type = st.selectbox('Work Type: Government Job = 0, Never Worked = 1, Private = 2, Self-employed = 3, Children = 4', ('Government Job', 'Never Worked', 'Private', 'Self-employed', 'Children'))
    ...
    with col1:
        ...
        Residence = st.selectbox('Residence: Rural = 0, Urban = 1', ('Rural', 'Urban'))
        if Residence == 'Rural':
            residence = 0
        else:
            residence = 1
    ...
    with col2:
        ...
        Smoking_Status = st.selectbox('Smoking Status: Unknown = 0, Formely Smoked = 1, Never Smoked = 2, Smokes = 3', ('Unknown', 'Formely Smoked', 'Never Smoked', 'Smokes'))
